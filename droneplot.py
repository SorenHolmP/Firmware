...
convert_ulog2csv(latest_file, 'vehicle_local_position,vehicle_local_position_groundtruth,sensor_combined,actuator_outputs,vehicle_attitude,vehicle_attitude_groundtruth', False, ',')
...
plt.scatter(trueatt['timestamp'], truepitch, color='g')
plt.scatter(trueatt['timestamp'], trueroll, color = 'r')
plt.scatter(truepos['timestamp'],truepos['z'], color = 'chocolate')
